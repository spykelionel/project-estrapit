...
# Définition de la liste des objets et de leurs caractéristiques (poids et valeur)
objects = [
    {"cost": 2, "duration": 10,"granularity":"D"}, #c1
    {"cost": 3, "duration": 5,"granularity":"D"},#c2
    {"cost": 5, "duration": 15,"granularity":"D"},#c3
    {"cost": 7, "duration": 7,"granularity":"D"},#c4
    {"cost": 1, "duration": 6,"granularity":"I"},#c5
    {"cost": 4, "duration": 18,"granularity":"I"},#c6
    {"cost": 1, "duration": 3,"granularity":"I"},#c7
   
]
maximum_cost = 10  # Poids maximal autorisé du sac à dos
...
best_solution,population = genetic_algorithm()
